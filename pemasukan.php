...
$data_masuk = mysqli_query($koneksi, "SELECT * FROM pemasukan_barang");
$data_barang = select("SELECT * FROM barang");
$data_pelanggan = select("SELECT * FROM pelanggan");

//cek apakah tombol add ditekan
if (isset($_POST['tambah'])) {
  if (create_datamasuk($_POST) > 0) {
    echo "<script>
...
<table class="shadow-lg p-3 mb-5 bg-body rounded">
    ...
    <tbody>
      <?php $no = 1; ?>
      <?php while($pemasukan = mysqli_fetch_array($data_masuk)) {
        $pegawai = $pemasukan['id_pegawai'];
        $id_barang = $pemasukan['id_barang'];
        $nama_barang = $pemasukan['nama_barang'];
        $nota = $pemasukan['no_notabeli'];
        $tanggal = $pemasukan['tgl_transaksi'];
        $jumlah = $pemasukan['jmlh_barang'];
      ...
      ?>
            ...
            <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-secondary" href="pemasukan_hapus.php?no_notabeli=<?= $nota?>" 
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="mb-3">
                        <label for="no_notabeli" class="form-label">Nomor Nota Jual</label>
                        <input type="number" class="form-control" name="no_notabeli" value="<?= $nota; ?>" id="no_notabeli" disabled>
                        <input type="hidden" name="no_notabeli(edit)" id="no_notabeli(edit)" value="<?= $nota; ?>">
                      </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form class="p-3 bg-body rounded" method="post" action="">
            ...
            <div class="modal-body">
            <div class="mb-3">
              <label for="no_notabeli" class="form-label">Nomor Nota Beli</label>
              <input type="number" class="form-control" name="no_notabeli" id="no_notabeli" required>
            </div>
